...
PLUGIN_SLUG="solr-power"

# GITHUB user who owns the repo
GITHUB_REPO_OWNER="pantheon-systems"

# GITHUB Repository name
GITHUB_REPO_NAME="solr-power"
...
svn propedit svn:ignore Gruntfile.js
svn propedit svn:ignore composer.json
svn propedit svn:ignore multisite.xml
svn propedit svn:ignore phpunit.xml
